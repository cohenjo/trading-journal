...
export const EXPENSE_CATEGORIES: ExpenseCategory[] = [
  ...
  },
  {
    ...
    is_transfer: false,
    subcategories: [
      { id: "cat-housing-water", slug: "housing-water", name: "Water", name_he: "מים", parent_slug: "housing" },
      { id: "cat-housing-electricity", slug: "housing-electricity", name: "Electricity", name_he: "חשמל", parent_slug: "housing" },
      { id: "cat-housing-gas", slug: "housing-gas", name: "Gas", name_he: "גז", parent_slug: "housing" },
      { id: "cat-housing-home-insurance", slug: "housing-home-insurance", name: "Home Insurance", name_he: "ביטוח דירה", parent_slug: "housing" },
      { id: "cat-housing-property-tax", slug: "housing-property-tax", name: "Property Tax", name_he: "ארנונה", parent_slug: "housing" },
      { id: "cat-housing-hoa", slug: "housing-hoa", name: "Building HOA", name_he: "ועד בית", parent_slug: "housing" },
      { id: "cat-housing-home-maintenance", slug: "housing-home-maintenance", name: "Home Maintenance", name_he: "תחזוקת הבית", parent_slug: "housing" },
    ],
  },
  {
    id: "cat-other",
